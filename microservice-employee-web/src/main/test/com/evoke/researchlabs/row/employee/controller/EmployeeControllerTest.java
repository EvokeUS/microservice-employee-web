...
public class EmployeeControllerTest {
	...
	/**
	 * Test method for {@link com.evoke.researchlabs.row.employee.controller.EmployeeController#executeLogin(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, com.evoke.researchlabs.row.employee.beans.Employee, org.springframework.validation.BindingResult)}.
	 */
	@Test
	public void testExecuteLogin_success() {
		when(restfulclient.postEntity(employee)).thenReturn(true);
		// employeeController.executeLogin(request, response, employee, result);
